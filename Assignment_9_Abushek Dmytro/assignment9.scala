object assignment9 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val ExtendWithApplyFunctionForYes: ExtendWithApplyFunction[Yes[String]] = new ExtendWithApplyFunction[Yes[String]](new Yes("s22779"))
    ...
    val ExtendWithGetOrElseForYes: ExtendWithGetOrElse[Yes[String]] = new ExtendWithGetOrElse[Yes[String]](new Yes("s22779"))
